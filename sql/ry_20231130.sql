...
(
    ...
    id_card        VARCHAR(64) UNIQUE COMMENT '身份证',
    class_id       INT UNSIGNED DEFAULT 0 COMMENT '班级ID',
    major_id       INT UNSIGNED DEFAULT 0 COMMENT '专业ID',
    articles_count INT UNSIGNED DEFAULT 0 DEFAULT 0 COMMENT '文章数量',
    introduction   VARCHAR(500) COMMENT '简介',
    honors         VARCHAR(500) COMMENT '荣誉',
    projects       VARCHAR(500) COMMENT '项目',
...
insert into sys_menu
values ('118', '文章管理', '1', '6', 'article', 'system/article/index', '', 1, 0, 'C', '0', '0', 'system:article:list',
        'peoples', 'admin', sysdate(), '', null, '文章管理菜单');
insert into sys_menu
values ('119', '文章评论管理', '1', '6', 'article_comment', 'system/article_comment/index', '', 1, 0, 'C', '0', '0', 'system:article_comment:list',
        'peoples', 'admin', sysdate(), '', null, '文章评论管理');
insert into sys_menu
values ('120', '文章标签管理', '1', '6', 'article_tag', 'system/article_tag/index', '', 1, 0, 'C', '0', '0', 'system:article_tag:list',
        'peoples', 'admin', sysdate(), '', null, '文章标签管理');
insert into sys_menu
values ('121', '通知管理', '1', '6', 'notification', 'system/notification/index', '', 1, 0, 'C', '0', '0', 'system:notification:list',
        'peoples', 'admin', sysdate(), '', null, '通知管理');
-- 三级菜单
insert into sys_menu
...
-- 文章管理按钮
insert into sys_menu
values ('1061', '文章查询', '118', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:article:list', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1062', '文章新增', '118', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:article:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1063', '文章修改', '118', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:article:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1064', '文章删除', '118', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:article:remove', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1073', '文章审查', '118', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:article:review', '#', 'admin', sysdate(), '',
        null, '');
-- 文章评论管理
insert into sys_menu
values ('1065', '评论查询', '119', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_comment:list', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1066', '评论新增', '119', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_comment:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1067', '评论修改', '119', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_comment:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1068', '评论删除', '119', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_comment:remove', '#', 'admin', sysdate(), '',
        null, '');
-- 文章标签管理
insert into sys_menu
values ('1069', '标签查询', '120', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_tag:list', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1070', '标签新增', '120', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_tag:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1071', '标签修改', '120', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_tag:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1072', '标签删除', '120', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:article_tag:remove', '#', 'admin', sysdate(), '',
        null, '');
-- 通知管理
insert into sys_menu
values ('1074', '通知查询', '121', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:notification:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1075', '通知新增', '121', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:notification:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1076', '通知修改', '121', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:notification:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1077', '通知删除', '121', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:notification:remove', '#', 'admin', sysdate(), '',
        null, '');
-- ----------------------------
-- 6、用户和角色关联表  用户N-1角色
-- ----------------------------
